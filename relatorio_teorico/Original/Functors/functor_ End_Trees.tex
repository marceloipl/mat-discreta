\subsection{Alínea 3.v) --- Functor $F: \mathbf{End} \to \mathbf{Trees}$}
\label{subsec:functor-end-trees}

\subsubsection{Functor Covariante $F: \mathbf{End} \to \mathbf{Trees}$}

\begin{definition}[Functor covariante $F: \mathbf{End} \to \mathbf{Trees}$]
...
\begin{lstlisting}[style=matlab, caption={Functor covariante $F: \mathbf{End} \to \mathbf{Trees}$}]
...
\paragraph{Adjunção com $U: \mathbf{Trees} \to \mathbf{End}$.}
