% ============================================================
\section{Funtor \texorpdfstring{$F: Simp \to PreOrd$}{F: Simp -> PreOrd}}
...
\subsection{Funtor Covariante \texorpdfstring{$F: Simp \to PreOrd$}{F: Simp -> PreOrd}}
...
\begin{lstlisting}[style=matlab, caption={[Funtor F: Simp -> PreOrd] Funtor $F: \mathbf{Simp} \to \mathbf{PreOrd}$ --- construção da pré-ordem de $[n]$}]
...
\begin{lstlisting}[style=matlab, caption={[Exemplo: F([2])] Exemplo: $F([2])$ e verificação de morfismo}]
n = 2;
...
\begin{lstlisting}[style=matlab, caption={[Transformação natural eta: G -> F] Transformação natural $\eta: G \Rightarrow F$ --- pré-ordem trivial para linear}]
