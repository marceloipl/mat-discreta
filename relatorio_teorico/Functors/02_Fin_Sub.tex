% ============================================================
\section{Funtor \texorpdfstring{$P: Fin \to Sub$}{P: Fin -> Sub}}
...
\subsection{Funtor Covariante \texorpdfstring{$P: Fin \to Sub$}{P: Fin -> Sub} (Conjunto das Partes)}
...
\subsection{Funtor de Esquecimento \texorpdfstring{$U: Sub \to Fin$}{U: Sub -> Fin}}
...
\subsection{Funtor Contravariante \texorpdfstring{$P^*: Fin^{\mathrm{op}} \to Sub$}{P*: Fin\^op -> Sub} (Imagem Inversa)}
