% ============================================================
\section{Funtor \texorpdfstring{$F: Fin \to Vect$}{F: Fin -> Vect}}
...
\subsection{Funtor Covariante \texorpdfstring{$F: Fin \to Vect$}{F: Fin -> Vect} (Funtor Livre)}
...
\subsection{Funtor de Esquecimento \texorpdfstring{$U: Vect \to Fin$}{U: Vect -> Fin}}
...
\subsection{Transformações Naturais \texorpdfstring{$\eta: F \Rightarrow G$}{eta: F => G}}
