% ════════════════════════════════════════════════════════════════
% CAPÍTULO 5 -- EQUAÇÕES DIFERENCIAIS ORDINÁRIAS DE PRIMEIRA ORDEM
% Ficheiro para \include{} no template principal.
%
% NOTA PARA O TEMPLATE PRINCIPAL: Este capítulo utiliza:
%   \usepackage{multicol}   % para listas a duas colunas
%   \usepackage{tabularx}   % já incluído no template principal
% ════════════════════════════════════════════════════════════════

% Macros locais usadas neste capítulo (não definidas no template principal)
\providecommand{\R}{\mathbb{R}}
\providecommand{\ODE}{\textsc{edo}}

\chapter{Equações Diferenciais Ordinárias de Primeira Ordem}

\begin{notebox}[title={Tópicos Abordados neste Capítulo}]
\begin{tabular}{ll}
...
% Campo de direções para dy/dx = y(1-y)
\begin{figure}[h]
\centering
\begin{tikzpicture}
  \begin{axis}[
  ...
  \end{axis}
\end{tikzpicture}
\caption{Campo de direções da equação logística $\frac{\dd y}{\dd x} = y(1-y)$, com curvas solução características.}
\end{figure}
...
\begin{defbox}[title={Equação Diferencial Ordinária (EDO) de Primeira Ordem}]
...
\label{sec:classification5}

\subsection{Ordem e Grau}

\begin{defbox}[title={Ordem e Grau de uma EDO}]
  \begin{itemize}
...
Todas as equações tratadas neste capítulo são de \emph{primeira ordem} (a derivada mais elevada
é $y'$) e, salvo indicação em contrário, de \emph{primeiro grau}.

\subsection{Linearidade}

\begin{defbox}[title={EDO Linear de Primeira Ordem}]
...
\begin{defbox}[title={EDO Autónoma}]
...
\label{sec:solutions5}

\begin{defbox}[title={Soluções de uma EDO}]
  \begin{itemize}
...
\label{sec:separable5}

\subsection{Definição e Método de Resolução}

\begin{defbox}[title={EDO Separável}]
...
\label{sec:applications5}

\subsection{Lei do Arrefecimento de Newton}

\begin{defbox}[title={Modelo de Arrefecimento de Newton}]
...
% ────────────────────────────────────────────────────────
\section{Questões Propostas para Defesa Oral}
\label{sec:oral5}
